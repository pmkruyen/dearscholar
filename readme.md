...
:running: *Note*. This master branch contains the source code of the stable, current release available on iOS devices (iPhones and iPads) and Android devices. The developer branch in this repro contains the newest developer release offering more flexibility to researchers with regard to the survey modules (number of modules and type of modules). The developer release will be soon submitted to the App Store and Google Play.
