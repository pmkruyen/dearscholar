...
// populate the surveyStructure table
    ...
    $con->prepare("INSERT INTO surveyStructure (consent, manual) VALUES (?, ?)");
    $stmt->bind_param("ssssss", $consent, $manual);
    $stmt->execute();

// populate the pageStructure table, moduleStructure table, and questionTable table --> see the samplestudy-part2.sql file
