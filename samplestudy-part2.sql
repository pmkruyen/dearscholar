...
('E', '\'tab tab-active\'', 'tab-1as', 'Vraag 1 van 9', 'q1s=nee', 'Nee', 'click', '#tab-7as', 'q1s=ja', 'Ja', 'click', '#tab-2as'),
...
('E', 'tab', 'tab-3as', 'Vraag 5 van 9', 'q3s=nee', 'Nee', 'click', '#tab-4bs', 'q3s=ja', 'Ja', 'click', '#tab-4as'),
...
('F', '\'tab tab-active\'', 'tab-1ao', 'Vraag 1 van 6', 'q1o=nee', 'Nee', 'click', '#tab-7ao', 'q1o=ja', 'Ja', 'click', '#tab-2ao'),
